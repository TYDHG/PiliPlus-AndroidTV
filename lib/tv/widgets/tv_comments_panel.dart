...
import 'package:PiliPlus/tv/widgets/tv_feed_grid.dart'
    show TvLoadingView, TvStatusView;
...
class _TvCommentsPanelState extends State<TvCommentsPanel> {
  ...
  bool _didFocusFirstComment = false;
  ...
  void _focusFirstComment() {
    if (_didFocusFirstComment || _nodes.isEmpty) return;
    _didFocusFirstComment = true;
      ...
      itemBuilder: (context, index) {
        ...
        return Padding(
          ...
          child: TvCommentRow(
            ...
            autofocus: i == 0,
            focusNode: _nodes[i],
            onKeyEvent: (node, event) => _onNestedKey(i, event, replies.length),
          ),
        );
      },
    );
